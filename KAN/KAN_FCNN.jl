...
function KAN_FCNN(input_size, output_size, hidden_dims, wavelet_names, base_activations, batch_norms)
    layers = []
    ...
    return KAN_FCNN(layers)
end

function (m::KAN_FCNN)(x)
